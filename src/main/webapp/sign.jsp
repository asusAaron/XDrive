...
<div class="center">
   <form id="sign" class="logintext"method="post">
       <div class="inputstyle">
          ...
          <input id="phone" type="text" onBlur="checkPhoneInput()" placeholder="手机号码" name="username" class="logintext-input"></input>
       </div>
       <p id="checkPhoneInputResult"></p>
       
       <div class="inputstyle">
          <span class="glyphicon glyphicon-envelope"></span>&nbsp;&nbsp;&nbsp;&nbsp;
          <input id="email"type="email" placeholder="邮箱" name="username" class="logintext-input"></input>
       </div>
       
       <div class="inputstyle">
          <span class="glyphicon glyphicon-lock"style="color:white"></span>&nbsp;&nbsp;&nbsp;&nbsp;
          <input onBlur="checkPassword()" id="password1" type="password" placeholder="密码" name="password" class="logintext-input"></input>
       </div>
       <p id="checkPasswordResult"></p>
       
       <div class="inputstyle">
          <span class="glyphicon glyphicon-lock"style="color:white"></span>&nbsp;&nbsp;&nbsp;&nbsp;
          <input onBlur="checkSame()" id="password2" type="password" placeholder="密码确认" name="password" class="logintext-input"></input>
       </div>
       <p id="checkSameResult"></p>
       
       <div class="logintext-submit"><input onclick="checkId()" type="submit" value="Sign up" 
            style="width:310px;box-shadow: 0px 10px 5px #888888;" class="btn btn-danger"/> 
       </div>   
    </form>   
</div>
<!-- 右边布局  -->
<div class="right">
   <div class="back">
      ...
      <a href="introduce_item.jsp"style="color:white">项目介绍</a>
   </div>
</div>
<!-- 底部布局  -->
<div class="bottom">
...
function checkPhoneInput(){
	...
	if(input.length!=11){
		...
		document.getElementById("checkPhoneInputResult").innerHTML="";
