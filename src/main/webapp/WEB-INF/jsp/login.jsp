...
<div class="center">
    <form id="login" class="logintext" name="myForm">
        ...
        <div class="inputstyle">
            ...
            <input type="text" name="email" placeholder="邮箱" id="email" class="logintext-input"
                   onBlur="validateForm()"/>
        </div>
        <p id="checkEmailInputResult"></p>
        <div class="inputstyle">
            <span class="glyphicon glyphicon-lock" style="color:white"></span>&nbsp;&nbsp;
            <input id="password" type="password" placeholder="密码" name="password" class="logintext-input">
        </div>
        <!-- 验证码 -->
        <div class="inputstyle">
        ...
        <div class="logintext-submit"><input id="btn_login" value="Sign in" class="btn btn-danger"
                                             style="width:310px;box-shadow: 0px 10px 5px #888888;height:100%;"/>
            <p id="msg"></p>
        </div>
        <div class="logintext-create">
            <a href="sign">没有账号 ？ 立即注册！</a>
        </div>
    </form>
</div>
<!-- 右边布局 -->
...
<script type="text/javascript">
    ...
    function validateForm() {
        ...
        if (atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length) {
            $("#checkEmailInputResult").style.color = 'red';
            $("#checkEmailInputResult").innerHTML = "不是正确的邮箱类型!";
...
/**----------------------------登录操作----------------------------------------- */
    ...
    btnLogin.click(function () {
        ...
        if(publicKey != null) {
            ...
            var username = encrypt.encrypt(user);
