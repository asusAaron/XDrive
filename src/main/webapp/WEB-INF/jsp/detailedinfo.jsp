...
<div class="text">
      <div class="block">
         ...
         <input type="text" name="u_account" class="nav userInput"  placeholder="请输入账户"
                readonly="readonly"/>
      </div>
      <div class="block">
         <label>&emsp;&emsp;姓名：&emsp;</label>
         <input type="text" name="u_name"    class="nav userInput"  placeholder="请输入姓名"
                value=""/>
      </div>
      <div class="block">
         <label>&emsp;&emsp;性别：&emsp;</label>      
         <select id=" i_sex" name="i_sex" class="userInput">
      ...
      <div class="block userInfo">
         ...
         <input type="date" name="i_birthday"    class="nav userInput"
                value="">
      </div>
      <div class="block">
         <label>&emsp;&emsp;住址：&emsp;</label>
         <input type="text" name="i_location"    class="nav userInput"  placeholder="请输入住址"
                />
      </div>
      <div class="block">
         <label>&emsp;&emsp;工作：&emsp;</label>
         <select id="i_job" name="i_job" class="userInput">
            <option selected="selected">选择职业</option>
            <option value="student">学生</option>
            <option value="officer">公务员</option>
            <option value="doctor">医疗</option>
            <option value="computer">计算机</option>
            <option value="others">其他职业</option>
         </select>
      </div>
      <div class="block">
         <label>&emsp;&emsp;学校：&emsp;</label>
         <input type="text" name="i_school"    class="nav userInput"  placeholder="请输入学校"
               />
      </div>
      <div class="block">
         <label>&emsp;&emsp;公司：&emsp;</label>
         <input type="text" name="i_company"    class="nav userInput"  placeholder="请输入公司"
               />
      </div>
      <div class="block">
         <label>&emsp;&emsp;签名：&emsp;</label>
         <input type="textarea" name="i_signature"    class="nav userInput"  placeholder="编辑个人签名"
               />
      </div>
      <div class="block">
          <input id="btn_modify" class="btn btn-primary" value="修改" />
          <input id="btn_cancel" class="btn btn-danger" value="取消" style="display: none">
      </div>
    ...
    $(function () {
        ...
        $("#btn_modify").click(function () {
            ...
            if($(this).val()=="修改"){
                ...
                $.ajax({
                    url:"<%=path%>/user/modifyInfos",
                    method:"post",
                    data:{detailedInfos:JSON.stringify(arr)},
                    error: function (jqXHR, textStatus, errorThrown) {
                        console.log(jqXHR);
                        console.log(textStatus);
                        console.log(errorThrown);
